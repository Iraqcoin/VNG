...
public class ApiIncreaseTest {
    ...
    public static Collection data() throws IOException {
        return new ReadExcel("/home/hoaibao/testcase.xls", 2).read();
    }

    public ApiIncreaseTest(String username, String expected) {
        super();
    ...
    @Test
    public void testIncreaseVisitorUser() {
        ...
        try {
            ...
            User u = client.Increase(this.username);
