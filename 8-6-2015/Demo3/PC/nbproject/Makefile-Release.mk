...
${OBJECTDIR}/Conﬁguration.o: Conﬁguration.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Conﬁguration.o Conﬁguration.cpp
...
${OBJECTDIR}/LoggingConfig.o: LoggingConfig.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/LoggingConfig.o LoggingConfig.cpp
...
${OBJECTDIR}/Mysql.o: Mysql.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Mysql.o Mysql.cpp

${OBJECTDIR}/Notiﬁcation.o: Notiﬁcation.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Notiﬁcation.o Notiﬁcation.cpp
...
${OBJECTDIR}/TestLibrary.o: TestLibrary.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TestLibrary.o TestLibrary.cpp
