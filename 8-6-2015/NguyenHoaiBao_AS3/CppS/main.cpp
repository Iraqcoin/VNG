...
public:
    ...
    void GetUser(User& _return, const std::string& username) {
        ...
        DataProvider data; // truy xuất CSDL
        ...
        } else { // nếu có cache thì không cần truy xuất CSDL
...
POCO_SERVER_MAIN(SampleServer) //Using Poco main macro
